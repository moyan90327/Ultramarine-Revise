...
public class WoodworkingRecipeCategory extends AbstractRecipeCategory<WoodworkingRecipe> {
    ...
    public WoodworkingRecipeCategory(IGuiHelper guiHelper) {
        super(WOODWORKING_RECIPE_TYPE, Component.translatable("gui.jei.category.woodworking"), guiHelper.createDrawableItemLike(ModBlocks.WOODWORKING_WORKBENCH), WIDTH, HEIGHT);
    }
